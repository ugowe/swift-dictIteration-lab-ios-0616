...
var bandsGreatestHits = ["Nirvana": "Nevermind",
...
bandsGreatestHits["Pixies"] = "Doolittle"
...
bandsGreatestHits["The Kinks"] = nil
...
print("\(bandName)'s top-selling album was \(bandsGreatestHits[bandName]!)")
...
for (band, album) in bandsGreatestHits {
...
for (grade, score) in gradeAndScore {
    print("\(grade) got a \(score)")
}
